...
$stmt = $link->prepare("INSERT INTO sub_activities_".$project_id." (Sub_ID, Main_ID, Sub_Activity,Date, Duration,Party_Involved,Position) VALUES(?,?,?,?,?,?,?)");
$stmt->bind_param("iissisi",$sub_id,$main_id,$sub_activity,$date,$duration,$party_involved,$index);
$stmt->execute();
